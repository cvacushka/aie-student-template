...
Эндпоинт принимает CSV-файл и возвращает **полный набор флагов качества**, включая новые эвристики из HW03:
...
- а также базовые флаги: `too_few_rows`, `too_many_columns`, `too_many_missing`.
...
Состав словаря флагов зависит от реализованных эвристик в HW03.
